...
par(new = TRUE)
plot(e1[e1[ ,3] == 1, c(1, 2)], col = c("red"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "population 1")

plot(e2[e2[ ,3] == 0, c(1, 2)], col = c("blue"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "")
par(new = TRUE)
plot(e2[e2[ ,3] == 1, c(1, 2)], col = c("red"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "population 2")

plot(e3[e3[ ,3] == 0, c(1, 2)], col = c("blue"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "")
par(new = TRUE)
plot(e3[e3[ ,3] == 1, c(1, 2)], col = c("red"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "population 3")

plot(e4[e4[ ,3] == 0, c(1, 2)], col = c("blue"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "")
par(new = TRUE)
plot(e4[e4[ ,3] == 1, c(1, 2)], col = c("red"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "population 4")

plot(e5[e5[ ,3] == 0, c(1, 2)], col = c("blue"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "")
par(new = TRUE)
plot(e5[e5[ ,3] == 1, c(1, 2)], col = c("red"), ylim = c(-3, 4), xlim = c(-3, 4), xlab = "", ylab = "", main = "population 5")
